...
const userDB = {
    ...
    search:(word,callback)=>{
        userOperate.search("hopereader",["readerName","readerGroup"],word,(err, rows, fields) => {
            if(err) {
                console.log(err);
                return;
            }
...
const bookDB ={
    ...
    search:(word,callback)=>{
        bookOperate.search("hopebook",["bookName","bookHopeID","bookAuthor","bookPress"],word,(err, rows, fields) => {
            if(err) {
                console.log(err);
                return;
            }
...
const equipDB ={
    ...
    search:(word,callback)=>{
        equipOperate.search("hopeequip",["equipName","equipHopeID"],word,(err, rows, fields) => {
            if(err) {
                console.log(err);
                return;
            }
